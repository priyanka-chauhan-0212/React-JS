...
import { FORGET_PASSWORD_SEND_EMAIL_API_PATH } from '../ApiRoutes/ApiRoutes';

// ** ForgetPasswordSchema -- schema for yup validation
...
const ForgotPasswordCover = () => {
	...
	const submitForm = (data) => {
		...
		// ** forgetPasswordSendEmail Api call -----------------------------
		axiosInstance
			.post(FORGET_PASSWORD_SEND_EMAIL_API_PATH, data)
			.then((res) => {
